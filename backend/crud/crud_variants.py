...
def serialize_variant(variant: VarianteProducto) -> dict:
    return {
        ...
        "imagen_fit": variant.imagen_fit,
        "imagen_posicion_x": variant.imagen_posicion_x,
        "imagen_posicion_y": variant.imagen_posicion_y,
        "imagen_zoom": variant.imagen_zoom,
        "imagen_fondo": variant.imagen_fondo,
